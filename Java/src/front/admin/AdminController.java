...
import src.front.editPizza.EditPizzaController;
import src.front.orderPizza.OrderPizzaController;
import src.pizzeria.customer.Customer;
import src.pizzeria.customer.CustomerService;
import src.pizzeria.delivery.Delivery;
import src.pizzeria.delivery.DeliveryService;
import src.pizzeria.deliveryPerson.DeliveryPerson;
import src.pizzeria.deliveryPerson.DeliveryPersonService;
import src.pizzeria.divers.DiversService;
import src.pizzeria.ingredient.Ingredient;
import src.pizzeria.ingredient.IngredientService;
import src.pizzeria.order.OrderService;
import src.pizzeria.order.PizzaOrder;
import src.pizzeria.pizza.Pizza;
import src.pizzeria.pizza.PizzaService;
import src.pizzeria.stats.StatsService;
import src.pizzeria.vehicle.Vehicle;
import src.pizzeria.vehicle.VehicleService;
            ...
            return new TableCell<Pizza, Button>() {
...

                {
                    pizza_orderButton.setOnAction(event -> {
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource(Config.getProperty("path.orderPizzaScene")));
            ...
            return new TableCell<Pizza, Button>() {
...

                {
                    editButton.setOnAction(event -> {
                        Pizza pizza = getTableView().getItems().get(getIndex());
                        Stage stage = new Stage();
                        FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource(Config.getProperty("path.editPizzaScene")));
